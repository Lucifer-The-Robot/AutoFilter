...
DATABASE_NAME = environ.get('DATABASE_NAME', "Lisa")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002483859543').split()]
